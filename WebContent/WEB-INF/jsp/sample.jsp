...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img class="logo-custom"
					src="resources/img/logo180-50.png" alt="" /></a>
			</div>
						...
						<div class="flexslider set-flexi" id="main-section">
							<ul class="slides move-me">
								...
								<li>
									...
									<h1>THE UNIQUE METHOD</h1> <a href="#features-sec"
									class="btn btn-info btn-lg"> GET AWESOME </a> <a
									href="#features-sec" class="btn btn-success btn-lg">
										FEATURE LIST </a>
								</li>
								<!-- End Slider 01 -->
								...
								<li>
									<h3>Delivering Quality Education</h3>
									<h1>UNMATCHED APPROACH</h1> <a href="#features-sec"
									class="btn btn-primary btn-lg"> GET AWESOME </a> <a
									href="#features-sec" class="btn btn-danger btn-lg">
										FEATURE LIST </a>
								</li>
								<!-- End Slider 02 -->
								...
								<li>
									<h3>Delivering Quality Education</h3>
									<h1>AWESOME FACULTY PANEL</h1> <a href="#features-sec"
									class="btn btn-default btn-lg"> GET AWESOME </a> <a
									href="#features-sec" class="btn btn-info btn-lg"> FEATURE
										LIST </a>
								</li>
								<!-- End Slider 03 -->
							</ul>
		...
		<div class="row text-center">
			<div
				...
				<h1 data-scroll-reveal="enter from the bottom after 0.2s"
					class="header-line">FEATURE LIST</h1>
			...
			<div class="row">
				...
				<div class="col-lg-4  col-md-4 col-sm-4"
					...
					<div class="faculty-div">
						<img src="resources/img/faculty/1.jpg" class="img-rounded" />
				...
				<div class="col-lg-4  col-md-4 col-sm-4"
					data-scroll-reveal="enter from the bottom after 0.5s">
					<div class="faculty-div">
						<img src="resources/img/faculty/2.jpg" class="img-rounded" />
						<h3>JANE DEO ALEX</h3>
						<hr />
						<h4>
				...
				<div class="col-lg-4  col-md-4 col-sm-4"
					data-scroll-reveal="enter from the bottom after 0.6s">
					<div class="faculty-div">
						<img src="resources/img/faculty/3.jpg" class="img-rounded" />
						<h3>RUBY DECORSA</h3>
						<hr />
						<h4>
	...
	<div id="course-sec" class="container set-pad">
		...
		<div class="row set-row-pad">
			<div class="col-lg-6 col-md-6 col-sm-6 "
				data-scroll-reveal="enter from the bottom after 0.4s">
				<img src="resources/img/building.jpg" class="img-thumbnail" />
			</div>
			<div
				...
				<div class="panel-group" id="accordion">
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapse1" class="collapsed"> <strong> 350+</strong>
									DESIGNING COURSES
								</a>
							</h4>
						</div>
					...
					<div class="panel panel-default"
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapse2" class="collapsed"> <strong> 250+</strong>
									ENGINEERING COURSES
								</a>
							</h4>
						</div>
					...
					<div class="panel panel-default"
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapse3" class="collapsed"> <strong> 153+</strong>
									MANAGEMENT COURSES
								</a>
							</h4>
						</div>
	...
	<div class="container">
		<div class="row set-row-pad">
			...
			<div
				...
				<hr />
				<div>
					<a href="#"> <img src="resources/img/Social/facebook.png"
						alt="" />
					</a> <a href="#"> <img src="resources/img/Social/google-plus.png"
						alt="" /></a> <a href="#"> <img
						src="resources/img/Social/twitter.png" alt="" /></a>
				</div>
			</div>
	...
	<div id="footer">
		&copy 2014 yourdomain.com | All Rights Reserved | <a
			href="http://binarytheme.com" style="color: #fff" target="_blank">Design
